...
function NameBox() {
  return (
    <div className="top-section">
      <img src={Me} className="personal-picture" alt="personal-picture" />
      <div className="mini1">
...
function SingleProjectBox({
  ...
  return (
    <div
      ...
      className={`single-project-box ${isHover ? "project-box-mouseOn" : "project-box-mouseOff"} ${isExpanded == name ? "project-box-expanded" : ""}`}
